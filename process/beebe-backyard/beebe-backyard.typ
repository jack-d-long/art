// beebe-backyard.typ
// Canonical source for process/beebe-backyard/index.html
// Build: npm run typst

#html.elem("h1")[Portraits at the Beebe Backyard Ultramarathon]
...
// TODO: lighting kit flick — image not yet available
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/gong.jpg", alt: "The admin tent, with gong and mallet ready for the start of the first lap. Image courtesy of Lily Blyn.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[The admin tent, with gong and mallet ready for the start of the first lap. Image courtesy of Lily Blyn.]
]
...
#html.elem("figure", attrs: (class: "todo-figure side-by-side"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5444.jpg", alt: "Harshil at 6:52 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5446.jpg", alt: "Harshil at 6:52 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Harshil at 6:52 AM.]
]

The sun rose at the beginning of the second lap, and I was thankful not only for the light, but for the clear sky.

#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/lake-at-sunrise.jpeg", alt: "The sky over the Beebe Dam Bridge at 7:40 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[The sky over the Beebe Dam Bridge at 7:40 AM.]
]

I ran three laps with Amy, the only runner I knew before the race. She was inspired by our friend Laine, who had run 50 miles at a similar event that she had organized the previous week. Amy made it 11 laps.

#html.elem("figure", attrs: (class: "todo-figure side-by-side"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5444.jpg", alt: "Amy at 7:50 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5446.jpg", alt: "Amy at 7:50 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Amy at 7:50 AM.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5451.jpg", alt: "Andrew and family at 9:55 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Andrew and family at 9:55 AM.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5455.jpg", alt: "Jack (far right) and friends at 10:51 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Jack (far right) and friends at 10:51 AM.]
]

I caught Johannes, a volunteer firefighter, in line for Gatorade, at the same white folding table as the Swedish Fish. He told his cousin, a hiker and ultramarathoner whose name escapes me, about this race. Johannes' cousin convinced him to run the race with him.

#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5458.jpg", alt: "Johannes (left) and mystery cousin at 10:55 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Johannes (left) and mystery cousin at 10:55 AM.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/purplepotato.jpeg", alt: "A purple salt potato, half-eaten at 12:00PM after 24 miles. I finished it just as I passed the Beebe Lake dam.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[A purple salt potato, half-eaten at 12:00PM after 24 miles. I finished it just as I passed the Beebe Lake dam.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/backyard-5473.jpg", alt: "Molly (left) and Claire at 11:55 AM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Molly (left) and Claire at 11:55 AM.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/jack-last.jpg", alt: "Jack at 12:57 PM.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[Jack at 12:57 PM.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/inthedark.jpeg", alt: "The first downhill stretch of Monkey Run trail, captured during a brief pause in rain around 7:20 PM. Image courtesy of Ethan Restivo.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[The first downhill stretch of Monkey Run trail, captured during a brief pause in rain around 7:20 PM. Image courtesy of Ethan Restivo.]
]
...
#html.elem("figure", attrs: (class: "todo-figure"))[
  #html.elem("img", attrs: (src: "/assets/process/beebe-backyard/scoreboard.jpeg", alt: "The scoreboard. Image courtesy of Isla Chadsey.", loading: "lazy", style: "width: 100%;"))
  #html.elem("figcaption")[The scoreboard at 9:00 PM. Image courtesy of Isla Chadsey.]
]
